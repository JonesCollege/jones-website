  ...
  return (
    <div>
      <div id='instaicon-wrap'>
        <SocialIcon url='https://instagram.com' fgColor='white' bgColor='rgba(243, 248, 244, 255)' style={{ height: 100, width: 100 }} id='instaicon'/>
      </div>
      ...
      <div id='presflexrow-bg'>
        <div id='presflexrow'>
          ...
          <div>
            ...
            <h4 id='prestitle'>PRESIDENT 2022-2023</h4>
            <p id='presintro'>Hey Jones! My name is Dan, and I'm the Jones president for the 2022-23 school year! 
              ...
              of the best college at Rice University and, as always, JIBA!!!</p>
              <p>- Dan Helmeci '23 (he/him)</p>
          </div>
        </div>
      </div>
    </div>
