  ...
  return (
    <div>
      <div className="oweek-text-container">
        <h1 className="oweek-h1">OWEEK</h1>
        <h3 className="oweek-h3">WELCOME FUTURE JONESIANS!</h3>
        <div className="oweek-letter-box">
          <p className="letter-p">{insertLineBreak(CoordLetter.text)}</p>
        </div>
        <div style={{ textAlign: "center" }}>
          <button className="open-letter-text" onClick={openLetterModal}>
            Read More
          </button>
        </div>
      </div>
  ...
  return (
    <>
      ...
      <div className="oweek-affiliate-container">
        ...
        <div className="oweek-paa-grid">{AffiliateMap(PAAs)}</div>
